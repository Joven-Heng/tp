...
public class PolicyCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Edits the Policy of the person identified "
            ...
            + "TBC, Existing remark will be overwritten by the input. \n"
            + "Parameters: INDEX (must be a positive integer) "
            + PREFIX_POLICY + "[POLICY]\n "
            + "Example: " + COMMAND_WORD + " 1 "
            + PREFIX_POLICY + "IP Shield package";
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        Person editedPerson = new Person(personToEdit.getName(), personToEdit.getPhone(),
                personToEdit.getEmail(), personToEdit.getAddress(), policy, personToEdit.getTags());
    ...
    /**
     * Generates a command execution success message based on whether the policy is added to or removed
     * {@code personToEdit}
     */
    private String generateSuccessMessage(Person personToEdit) {
        String message = !policy.value.isEmpty() ? MESSAGE_ADD_REMARK_SUCCESS : MESSAGE_DELETE_REMARK_SUCCESS;
    ...
    public boolean equals(Object other) {
        ...
        return index.equals(e.index) && policy.equals(e.policy);
    }
}
